...
public class ResepMakanan {
    ...
    public ResepMakanan(String namaMakanan,ArrayList<String> daftarBahan, List<String> daftarAlat, List<String> langkahLangkah, Database db) {
    ...
    public void setDaftarAlat(List<String> daftarAlat) {
        this.daftarAlat = daftarAlat;
    }
    ...
    public void setLangkahLangkah(List<String> langkahLangkah) {
        this.langkahLangkah = langkahLangkah;
    }
