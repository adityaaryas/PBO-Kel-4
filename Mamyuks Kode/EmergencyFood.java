...
//    private RoomChat roomChat;
    ...
    public EmergencyFood(int idPermintaan, LocalDate tanggalPermintaan, KategoriPermintaan kategoriPermintaan, boolean statusPermintaan, Akun penerimaDonasi, List<Donasi> daftarDonasi) {
    ...
    public EmergencyFood(int idPermintaan, LocalDate tanggalPermintaan, KategoriPermintaan kategoriPermintaan, boolean statusPermintaan, Akun penerimaDonasi) {
        this.idPermintaan = idPermintaan;
        this.tanggalPermintaan = tanggalPermintaan;
        this.kategoriPermintaan = kategoriPermintaan;
        this.statusPermintaan = statusPermintaan;
    ...
    public EmergencyFood(int idPermintaan, KategoriPermintaan kategoriPermintaan, Akun penerimaDonasi, List<Donasi> daftarDonasi) {
        this.idPermintaan = idPermintaan;
        this.kategoriPermintaan = kategoriPermintaan;
        this.penerimaDonasi = penerimaDonasi;
        this.daftarDonasi = daftarDonasi;
    ...
    public EmergencyFood(Database db, KategoriPermintaan kategoriPermintaan, Akun penerimaDonasi) {
//        this.tanggalPermintaan = tanggalPermintaan;
        this.db = db;
        this.kategoriPermintaan = kategoriPermintaan;
        this.penerimaDonasi = penerimaDonasi;
